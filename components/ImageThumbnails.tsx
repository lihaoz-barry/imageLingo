        ...
        {images.map((image) => (
          ...
          >
            ...
            <button
              ...
              className="absolute top-2 left-2 w-6 h-6 rounded-full bg-red-500/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity flex items-center justify-center hover:bg-red-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
            >
              <X className="w-4 h-4" />
            </button>
