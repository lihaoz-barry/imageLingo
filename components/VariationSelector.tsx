    ...
    <div className="flex items-center gap-3">
      ...
      <div className="relative">
        <select
          ...
          className="px-4 py-2 pr-10 rounded-full backdrop-blur-md bg-white/10 border border-white/20 text-[#00d4ff] cursor-pointer outline-none appearance-none hover:bg-white/15 transition-all"
        >
